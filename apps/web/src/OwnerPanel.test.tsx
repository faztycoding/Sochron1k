...
const emptyAlerts = () => ({ protocol: "sochron.operational-alerts.v3", trading_mode: "demo", read_only: true,
  ...
  api_budget: { protocol: "sochron.api-budget-view.v1", trading_mode: "demo", read_only: true,
    ...
    generated_at_utc: "2026-09-17T00:00:00Z", policy: null, evidence: null }, alerts: [],
