...
const emptyAlerts = () => ({ protocol: "sochron.operational-alerts.v4", trading_mode: "demo", read_only: true,
  ...
  generated_at_utc: "2026-09-17T00:00:00Z", truncated: false,
  api_budget: { protocol: "sochron.api-budget-view.v1", trading_mode: "demo", read_only: true,
    ...
    generated_at_utc: "2026-09-17T00:00:00Z", policy: null, evidence: null },
  delivery: { protocol: "sochron.alert-delivery-view.v1", state: "disabled", configured: false,
    ...
    last_verified_at_utc: null }, alerts: [],
