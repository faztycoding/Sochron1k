...
export const connectionDefinitions: Record<ConnectionId, Definition> = {
  ...
  operational_alerts: { title: "ศูนย์แจ้งเตือน", result: "เหตุสำคัญ coverage และ lifecycle ของ owner",
    ...
    required: "external alert delivery",
    sources: ["telemetry_status", "execution_status", "execution_journal", "bar_history", "policy_status", "alert_lifecycle", "api_budget_snapshot"],
    sourceLabel: "Runtime states + lifecycle journal + provider cost snapshot · ยังไม่ส่งแจ้งเตือนภายนอก", implementation: "partial" },
