...
export const connectionDefinitions: Record<ConnectionId, Definition> = {
  ...
  execution_evidence: { title: "คำสั่งและการป้องกันสถานะ", result: "Order / Deal / Position / SL ที่ยืนยันแล้ว", routes: ["/api/executor/v1/status"],
    required: "/api/owner/execution", sources: ["mt5_execution"], sourceLabel: "MT5 Execution EA", implementation: "partial" },
